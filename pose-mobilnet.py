...
def train_model(train_loader, val_loader):
    ...
    # Load pretrained MobileNet, skifter den sidste lay til to classer gun og no gun,sender modlen til enten CPU eller GPU
...
def main():
    ...
    train_dataset = HandDataset(f"{HAND_CROPS_DIR}/train", transform)
    val_dataset = HandDataset(f"{HAND_CROPS_DIR}/val", transform)
    test_dataset = HandDataset(f"{HAND_CROPS_DIR}/test", transform)
    ...
    for img_file in test_images:
        ...
        result_img, detections = detect_guns_in_image(model, img_path, transform)
